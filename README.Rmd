...
These days I'm focused a lot on package building.  I need a personal website update update.  Instead of trying to reboot my blogdown website or convert to quarto, I'm just using package building architecture to create an updated personal webpage.  I may explore some meta package writing here as well. 
...
For the last three years, I've worked in the Dean's Data Cell at the United States Military Academy at West Point in a data analytics and teaching dual role. 
